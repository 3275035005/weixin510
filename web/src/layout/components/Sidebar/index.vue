  ...
  <div>
    <div class="logo">
      ...
      >
        ...
        <!--             style="width: 120px; height: 31px">-->
        <span class="title-label" style=" font-weight: 500;
    font-size: 20px;
    color: #333333;
    margin-left: 10px;"
        > 菜谱管理系统</span>
...
export default class extends Vue {
  ...
  get routes() {
    ...
    let userInfo = JSON.parse(Cookies.get('user_info') as any);
    console.log(JSON.parse(Cookies.get('user_info') as any))
    ...
    if (menu) {
      if (menu) {
        if(userInfo.role === '1'){
          menuList = menu.children1
        } else {
          menuList = menu.children2
        }
      }
    }
    console.log('-=-=routes=-wwww=-=', menuList)
    return menuList
  }
