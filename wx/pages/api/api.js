...
export const getCategoryList = (type) => {
	return request({
		url: '/user/category/list?type='+type,
		method: 'GET'
	})
}
...
// 取消收藏
export const deleteCollectorById = (id) =>
	request({
		url: `/user/collector/deleteCollectorById?collectorId=`+id,
		method: 'delete'
	})
...
export const insertCollector = (params) =>
	request({
		url: `/user/collector/insertCollector`,
		method: 'post',
		params
	})
...
export const selectEmployeeById = () =>
	request({
		url: `/user/employee/selectEmployeeById`,
		method: 'get'
	})
// 修改个人信息
...
// 查询美食社区列表
export const shareList = (type) =>
	request({
		url: `/user/share/list?type=`+type,
		method: 'get'
	})
	
// 发布美食
export const insertShare = (params) =>
	request({
		url: `/user/share/insertShare`,
		method: 'post',
		params
	})
...
export const getShareById = (id) =>
	request({
		url: `/user/share/getShareById?shareId=`+id,
		method: 'get'
	})
...
export const searchName = (name) =>
	request({
		url: `/user/setmeal/search?name=`+name,
		method: 'get'
	})
